...
<form action="addressPaymentForOrderAction.jsp" method="post">
    <div class="left-div">
        <h3>Enter Address</h3>
        <input class="input-style" type="text" name="address" value="<%=rs2.getString(7)%>" placeholder="Enter Address">
    </div>
    ...
    <div class="right-div">
        <h3>Enter country</h3>
         <input class="input-style" type="text" name="country" value="<%=rs2.getString(10)%>" placeholder="Enter country">
    </div>
    ...
    <div class="right-div">
        ...
        <input class="input-style" type="text" name="transactionid"  placeholder="Enter transnaction id">
        <h3 style="color: red">*If you select online Payment then enter your transaction ID here, otherwise leave this blank</h3>
    </div>
    <hr style="width: 100%">
    <div class="left-div">
        <h3>Mobile Number</h3>
        <input class="input-style" type="text" name="mobile" value="<%=rs2.getString(3)%>" placeholder="Enter mobile number">
